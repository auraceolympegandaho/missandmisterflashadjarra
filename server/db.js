...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  status TEXT NOT NULL DEFAULT 'pending', -- pending | approved | declined | canceled
  created_at TEXT NOT NULL DEFAULT (datetime('now')),
...
// Seed default price setting if missing
...
// Seed / sync admin user from .env on every boot (so changing .env updates the password)
