...
const { pool, initSchema, DEFAULT_HOMEPAGE, DEFAULT_FAQ, DEFAULT_CONTACT, DEFAULT_ABOUT } = require("./db");
...
// Contenu propre a la page A propos (public, lecture seule ; gere depuis l'admin)
